...
const NAME = 'PricesPrimitive01'
const BG_SECTION = 'none'
const COVER = 'https://cdn.ptah.pro/tst/5ef9a42509b4c100015ca9d4/3d72899c-e860-4752-90ae-2073b32cf663.jpg'
const DESCRIPTION = 'Product list side expanded view'

let prev = [
  'https://cdn.ptah.pro/tst/5ef9a42509b4c100015ca9d4/71734bab-e0ab-4d45-8887-c1557e6cbd34.jpg'
]
...
const [
  ...
  return [
    ...
    {
      element: {
        text: `<h3><strong>${label[i]} edition</strong></h3>`,
        styles: {
          'font-size': '2.6rem',
          'color': '#575A5F',
          'margin-top': '20px'
  ...
  },
  {
    element: {
      ...
      icon: {
        value: 'start',
        name: 'start',
        text: '<strong>Starship mk1</strong>'
      },
      styles: {
        color: '#575A5F'
      }
