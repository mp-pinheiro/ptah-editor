...
const NAME = 'BlockTextsWithVideo01'
const BG_SECTION = 'none'
const COVER = 'https://cdn.ptah.pro/tst/5ef9a42509b4c100015ca9d4/f807e060-8e3f-4ded-b1e6-141aacea5b56.jpg'
...
const C_CUSTOM = [
  ...
  {
    element: {
      text: '<p>Live through the story and top the global ratings with your characters ' +
        'in the multiplayer mode. Unlock new characters and cards, ' +
