...
const NAME = 'VideoAndCallToAction02'
const BG_SECTION = 'none'
const COVER = 'https://cdn.ptah.pro/tst/5ef9a42509b4c100015ca9d4/6e328673-af91-4d7d-ae18-ac52ff975dd8.jpg'
...
const C_CUSTOM_2 = [
  {
    element: {
      settings: {
        ...
        rel: false,
        controls: false,
        url: 'https://youtu.be/GQAXmZl-Cuk'
      },
      styles: {
        width: '723px',
        height: '405px'
